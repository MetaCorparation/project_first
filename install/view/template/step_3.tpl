      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="db_hostname" value="127.0.0.1" id="input-db-hostname" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="db_username" value="iatielumegheeph" id="input-db-username" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="password" name="db_password" value="seechudiikierai" id="input-db-password" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-db-database"><?php echo $entry_db_database; ?></label>
            <div class="col-sm-10">
              <input type="text" name="db_database" value="opencart" id="input-db-database" class="form-control" />
